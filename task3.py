...
nomes_erros = {
    1: "URL falsa (g00gle)",
    2: "Selo 'Verificado' falso na barra",
    3: "Anúncio falso (Mina de Ouro)",
    4: "Botão 'X' falso no anúncio",
    5: "Erro ortográfico ('voçê')",
    6: "Botão Download Malicioso",
    7: "Identificou o Painel de Login Falso"
}
...
erros = [
    ...
    pygame.Rect(800, 125, 145, 160), # 2. Anúncio "Mina de Ouro"
    pygame.Rect(925, 110, 12, 12),   # 3. Botão "X" falso do anúncio
    pygame.Rect(185, 272, 110, 18),  # 4. Erro de português
    pygame.Rect(452, 452, 150, 30),  # 6. Botão de Download
    pygame.Rect(800, 340, 145, 160), # 7. Caixa inteira do formulário de Login Falso
]
